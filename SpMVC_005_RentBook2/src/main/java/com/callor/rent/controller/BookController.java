...
public class BookController {
	...
	/*
	 * @ModelAttribute("BOOK") 라는 선언이 있는 매개 변수가 발견되면
	 * BookDto bookDto 객체에 데이터가 있는지 확인하고 
	 * 만약 null값이면 새로운 BookDto 객체를 생성하여 주입하라.
	 */
	@ModelAttribute("BOOK")
	...
	/*
	 *  만약 Req를 하면서 num변수에 값을 포함하여 보낼때
	 *  문자열, "", 아무것도 없는 값 을 전달하면
	 *  서버는 400 오류가 난다.
	...
	public List<BookDto> bNameSearch(@RequestParam(name= "b_name", 
